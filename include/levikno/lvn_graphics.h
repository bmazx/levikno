...
typedef uint32_t          (*PFN_lvnSwapchainGetImageCount)(const LvnSwapchain*);
typedef LvnTexture*       (*PFN_lvnSwapchainGetImage)(LvnSwapchain*, uint32_t);
typedef LvnTexture*       (*PFN_lvnSwapchainGetDepthImage)(LvnSwapchain*);
...
struct LvnGraphicsContextFunctions
{
    ...
    PFN_lvnSwapchainGetImageCount             swapchainGetImageCount;
    PFN_lvnSwapchainGetImage                  swapchainGetImage;
    PFN_lvnSwapchainGetDepthImage             swapchainGetDepthImage;
...
LVN_API LvnTexture*                 lvnSwapchainGetDepthImage(LvnSwapchain* swapchain);
